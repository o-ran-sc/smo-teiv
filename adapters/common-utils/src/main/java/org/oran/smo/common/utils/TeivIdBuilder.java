...
public class TeivIdBuilder {
    ...
    /**
     * Builds relationshipType name with given relationship type, sourceId and destinationId.
     *
     * @param type
     ...
     */
    public static String buildRelationshipTypeName(String type, String sourceId, String destinationId) {
        return ORAN_SMO_TEIV_URN_PREFIX + sourceId + "_" + type + "_" + destinationId;
    }
