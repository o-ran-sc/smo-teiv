...
import static org.oran.smo.teiv.adapters.common.utils.Constants.FOCOM_PROVISION_REQUEST_NAME;
import static org.oran.smo.teiv.adapters.focom_to_teiv_adapter.service.JsonBuilder.getFocomtoTeivJson;
...
public class FocomToTeivIngestion {
    ...
    public void pollExternalApi() throws IOException {
        Map<String, Object> json = getFocomtoTeivJson(FOCOM_PROVISION_REQUEST_NAME);
