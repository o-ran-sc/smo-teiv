...
public class NRCellDU {
    ...
    public Map<String, Object> createTeivEntity() {
        String nrcellduId = "urn:oran:smo:teiv:" + this.getId();
        return Map.of("id", nrcellduId, "attributes", attributes.toTeiv(), "sourceIds", List.of(nrcellduId));
    }
    ...
    public Map<String, Object> createRelationshipWithGnbduFunction(String gnbduFunctionId) {
        ...
        return Map.of("id", String.format("urn:oran:smo:teiv:%s_PROVIDES_%s", gnbduFunctionId, getId()), "aSide",
            gnbduFunctionFdn, "bSide", nrcellduFdn, "sourceIds", List.of(
                gnbduFunctionFdn, nrcellduFdn));
    }
}
