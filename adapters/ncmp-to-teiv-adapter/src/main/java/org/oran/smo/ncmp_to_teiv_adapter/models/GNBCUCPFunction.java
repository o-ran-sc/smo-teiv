...
public class GNBCUCPFunction extends AbstractFunction {
    ...
    private void addRelationshipWithNrcellcu(NRCellCU nrCellCU, Map<String, List<Object>> relationshipMap) {
        String relType = TeivIdBuilder.buildEntityTypeName(SMO_TEIV_RAN_PREFIX, "OCUCPFUNCTION_PROVIDES_NRCELLCU");
    ...
    public Map<String, Object> createRelationshipWithManagedElement(String managedElementId) {
        ...
        return Map.of("id", TeivIdBuilder.buildRelationshipTypeName("MANAGES", managedElementId, getId()), "aSide",
    ...
    public void createRelationshipWithSmo(Map<String, List<Object>> relationshipMap) {
        String ranFunctionRelType = TeivIdBuilder.buildEntityTypeName(SMO_TEIV_RAN_PREFIX, "OCUCPFUNCTION_O1LINK_SMO");
        ...
        String smoId = "SMO";
        Map<String, Object> test = Map.of("id", TeivIdBuilder.buildRelationshipTypeName("O1LINK", gnbcucpFunctionId, smoId),
