...
public class GNBCUCPFunction extends AbstractFunction {
    ...
    public Map<String, Object> addTeivEntitiesAndRelationships(Map<String, List<Object>> entityMap,
        ...
        for (NRCellCU nrCellCU : getNrCellCUs()) {
            ...
            //            nrCellCUList.add(nrCellCU.addTeivEntitiesAndRelationships(entityMap, relationshipMap));
            //            gnbcucpFunctionNrcellcuRel.add(nrCellCU.createRelationshipWithGnbcucpFunction(getId()));
        }
        ...
        //        }
        //        entityMap.get(type).add(new ArrayList<>(nrCellCUList));
        //
        ...
        //        }
        //        relationshipMap.get(relType).add( new ArrayList<>(gnbcucpFunctionNrcellcuRel));
    ...
    private void addNrcellcuEntitiesAndRelationships(NRCellCU nrCellCU, Map<String, List<Object>> entityMap,
        ...
        entityMap.get(type).add(nrCellCU.addTeivEntitiesAndRelationships(entityMap, relationshipMap));
    }
