...
[
    ...
    Contract.make {
        ...
        response {
            ...
            "self": {
                "href": "/domains/REL_OAM_RAN/relationship-types/MANAGEDELEMENT_MANAGES_ODUFUNCTION/relationships?offset=0&limit=500&scopeFilter=/metadata[@reliabilityIndicator='OK']"
            },
            "first": {
                "href": "/domains/REL_OAM_RAN/relationship-types/MANAGEDELEMENT_MANAGES_ODUFUNCTION/relationships?offset=0&limit=500&scopeFilter=/metadata[@reliabilityIndicator='OK']"
            },
    ...
    Contract.make {
        ...
        response {
            ...
            body('''{
                ...
                "self": {
                    "href": "/domains/REL_OAM_RAN/relationship-types/MANAGEDELEMENT_MANAGES_ODUFUNCTION/relationships?offset=0&limit=500&scopeFilter=/metadata[@reliabilityIndicator='RESTORED']"
                },
                "first": {
                    "href": "/domains/REL_OAM_RAN/relationship-types/MANAGEDELEMENT_MANAGES_ODUFUNCTION/relationships?offset=0&limit=500&scopeFilter=/metadata[@reliabilityIndicator='RESTORED']"
                },
