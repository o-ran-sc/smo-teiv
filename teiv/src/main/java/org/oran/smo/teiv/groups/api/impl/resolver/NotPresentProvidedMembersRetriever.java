...
@Component
@Profile("groups")
public class NotPresentProvidedMembersRetriever extends ProvidedMembersRetriever {
    private final GroupsRepository groupsRepository;

    public NotPresentProvidedMembersRetriever(final GroupsRepository groupsRepository) {
    ...
    public OranTeivMembersResponse retrieve(final String groupId, final RequestDetails requestDetails)
        ...
        staticGroupRecord.getGroupedProvidedMembers().forEach((topologyType, providedMembersIds) -> {
            ...
            combinedQueries.add(groupsRepository.createQueryForNotPresentProvidedMembers(topologyObjectType.getTableName(),
