...
public class DataServiceImpl implements DataService {
    ...
    public OranTeivDomains getDomainTypes(final RequestDetails requestDetails) {
        ...
        return OranTeivDomains.builder().items(items).build();
    }
    ...
    public OranTeivEntityTypes getTopologyEntityTypes(final String domain, final RequestDetails requestDetails) {
        ...
        return OranTeivEntityTypes.builder().items(items).build();
    }
    ...
    public OranTeivRelationshipTypes getTopologyRelationshipTypes(final String domain,
        ...
        return OranTeivRelationshipTypes.builder().items(items).build();
    }
    ...
    public OranTeivRelationships getAllRelationshipsForObjectId(final String domain, final String entityName,
        ...
        if (!relationNamesForEntityByDomain.isEmpty()) {
            ...
            response = OranTeivRelationships.builder().items(List.of()).build();
        }
